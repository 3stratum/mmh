...
class change_production_qty(osv.osv_memory):
    ...
    def change_prod_qty(self, cr, uid, ids, context=None):
        ...
        if prod.state == 'in_production':
		    ...
		    factor = uom_obj._compute_qty(cr, uid, prod.product_uom.id, wiz_qty.product_qty, bom_point.product_uom.id)
			    ...
			    dest_move_id=move_lines_obj.search(cr,uid,[('move_dest_id','=',move.id)])
                            if dest_move_id:
                                move_lines_obj.write(cr, uid,dest_move_id,{'product_qty' :  r['product_qty']})
