    ...
    def get_interval_period (self, cr, uid, start_period=None, end_period=None, fiscal_year=None, initial_balance=False):
        ...
        #si es un balance "corriente"
            ...
            if start_period and end_period:
                ...
                ### below code is to get the last period to date stop
                period_list =  period_obj.search(cr, uid, [('fiscalyear_id','=',fiscal_year), ('date_start','>=',start_period.date_start),('date_stop','<=',end_period.date_stop)])
